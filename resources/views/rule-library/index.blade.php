        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
            <div class="text-center">
                ...
                <p class="text-sm text-gray-600 max-w-md mx-auto">
                    Livewire is not installed. Please install <code class="px-2 py-0.5 bg-gray-100 rounded text-xs font-mono">livewire/livewire</code> to enable rule library listing.
                </p>
            </div>
        </div>
            @endif
